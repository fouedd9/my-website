export type ProjectAccent = "violet" | "blue" | "green" | "orange" | "amber";
...
export const projectsFR: Project[] = [
  ...
  },
  {
    ...
    highlight: "Application métier utilisée quotidiennement en entreprise",
    technologies: [
      "React",
      "TypeScript",
      "React Query",
  ...
  },
  {
    ...
    headline: "Un assistant conversationnel connecté à Google Calendar.",
    description:
    ...
    highlight: "Automatisation complète d’un véritable workflow métier",
    technologies: [
      "TypeScript",
      "Node.js",
      "OpenAI",
  ...
  },
  {
    ...
    title: "My Cocoon",
    headline: "Une expérience digitale élégante pour un restaurant-café.",
    description:
    ...
    highlight: "Refonte UI/UX, multilingue et développement web",
    technologies: [
      "React",
      "JavaScript",
      "Responsive Design",
  ...
  },
  {
    ...
    category: "E-COMMERCE",
    title: "Lumina FR",
    headline: "Une marque digitale autour d’une lampe LED sans fil.",
    description:
    ...
    highlight: "Un véritable produit commercialisé sur le marché",
    technologies: [
      "React",
      "Landing Page",
      "Meta Ads",
...
export const projectsEN: Project[] = [
  {
    ...
    highlight: "A personal SaaS product designed from end to end",
    technologies: [
      "React",
      "TypeScript",
      "Node.js",
  ...
  },
  {
    ...
    title: "Yeetch HRIS",
    headline: "A complete HR platform designed to digitize internal processes.",
    description:
    ...
    highlight: "A business application used daily within companies",
    technologies: [
      "React",
      "TypeScript",
      "React Query",
  ...
  },
  {
    ...
    headline: "A conversational assistant connected to Google Calendar.",
    description:
    ...
    highlight: "End-to-end automation of a real business workflow",
    technologies: [
      "TypeScript",
      "Node.js",
      "OpenAI",
  ...
  },
  {
    ...
    title: "My Cocoon",
    headline: "An elegant digital experience for a restaurant and café.",
    description:
    ...
    highlight: "UI/UX redesign, multilingual support and web development",
    technologies: [
      "React",
      "JavaScript",
      "Responsive Design",
  ...
  },
  {
    ...
    category: "E-COMMERCE",
    title: "Lumina FR",
    headline: "A digital brand built around a wireless LED lamp.",
    description:
    ...
    highlight: "A real product successfully launched on the market",
    technologies: [
      "React",
      "Landing Page",
      "Meta Ads",
